...
- [QueryObserver] 的`atomsWithQuery`(https://tanstack.com/query/v4/docs/reference/QueryObserver)
- [InfiniteQueryObserver] 的`atomsWithInfiniteQuery`(https://tanstack.com/query/v4/docs/reference/InfiniteQueryObserver)
